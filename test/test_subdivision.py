...
class SubdivisionTest(TestCase):
    ...
    def test_rect_subdivision_easy(self):
        ...
        self.assertEqual(pow2_2d_subdivision(8640, 4320, tw_opt=1440, th_opt=1440), ((8640, 4320), (1080, 1080), (2, 1), 3))
        # Land Cover CCI
        self.assertEqual(pow2_2d_subdivision(129600, 64800), ((129600, 64800), (405, 405), (10, 5), 6))
    ...
    def test_rect_subdivision_hard(self):
        ...
        self.assertEqual(pow2_2d_subdivision(4823, 5221, w_mode=1, h_mode=-1),
                         ((4824, 4180), (201, 1045), (6, 1), 3))
        self.assertEqual(pow2_2d_subdivision(4823, 5221, w_mode=-1, h_mode=1),
                         ((3860, 5222), (965, 373), (2, 7), 2))
        self.assertEqual(pow2_2d_subdivision(4823, 5221, w_mode=-1, h_mode=-1),
                         ((3860, 4180), (965, 1045), (1, 1), 3))
        self.assertEqual(pow2_2d_subdivision(4823, 5221, w_mode=1, h_mode=1),
                         ((4824, 5222), (201, 373), (12, 7), 2))
